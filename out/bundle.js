(function (d3, d3Hierarchy) {
    ...
    class App {
        constructor(fileName = "example.json") {
            console.log(`create chart from ${fileName}`);
        ...
        drawChart(data) {
            ...
            const treeLayoutBuilder = d3Hierarchy.tree().nodeSize([
                personCellHeight,
                personCellWidth,
            ]);
            ...
            const linkFn = d3__default["default"]
                .linkHorizontal()
                .x((d) => d.y)
                .y((d) => d.x);
